...
%torexp_div: Toroidal coordinates growth following exponential growth (increasing xi)
...
%k = rho; %scaled to t
xif = @(t) asin(exp(-rho*(t+0.1))); %xi evolution in time. Matches exponential growth, 0.1 safety time interval
